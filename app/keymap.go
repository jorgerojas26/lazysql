...
var Keymaps = KeymapSystem{
	Groups: map[string]Map{
		HomeGroup: {
			...
			Bind{Key: Key{Char: 'F'}, Cmd: cmd.ToggleLeft, Description: "Toggle tree"},
			...
			Bind{Key: Key{Char: 'P'}, Cmd: cmd.ToggleTableListModal, Description: "Show table list modal"}, // Shift+P
